...
function addTwoToArray(array, fn){
  let total = [];
...
console.log(addTwoToArray(Number, addTwo));
/*
...
*/
function addThreeToArray(array, fn){
  let total = [];
  for(let num of array){
    total.push(fn(num));
  }
...
console.log(addThreeToArray(Number,addThree));
/*
  Create a function named addFiveToArray which accepts:
    ...
    - while doing so use the funciton addThree
*/
function addFiveToArray(array, fn){
  let total = [];
  for(let num of array){
    total.push(fn(num));
  }
...
console.log(addFiveToArray(Number, addFive));
/*
...
*/
function isGradeC(array){
  if(array.grade <= 8 || array.grade != 8){
    return true;
  } else {
    return false;
  }
...
*/
function filterFemale(array, cb){
  let final = [];
  for(let num of array){
    if(cb(num) == true){
      final.push(num);
...
*/
function filterGradeA(array, cb) {
  let final = [];
  for(let num of array){
    if(cb(num) == true){
      final.push(num);
...
*/
function filterGradeB(array, cb) {
  let final = [];
  for(let num of array){
    if(cb(num) == true){
      final.push(num);
...
*/
function filterGradeC(array, cb) {
  let final = [];
  for(let num of array){
    if(cb(num) == true){
      final.push(num);
